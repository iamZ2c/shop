...
type ServerConfig struct {
	InventorySrv InventorySrvConfig `mapstructrue:"inventory_srv" json:"inventory_srv"`
	...
	InventoryWeb InventoryWebConfig `mapstructrue:"inventoryWeb" json:"inventoryWeb"`
...
type InventoryWebConfig struct {
