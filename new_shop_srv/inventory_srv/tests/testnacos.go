...
func SqlClientInit() {
	...
	dsn := fmt.Sprintf("root:root@tcp(%v:%v)/shop_inventory_srv?charset=utf8mb4&parseTime=True&loc=Local", global.NacosConf.MysqlConfig.Host, global.NacosConf.MysqlConfig.Port)
